module { now, line, readUtf8, writeUtf8, display, cmdNew, cmdArgs, cmdStatus, deltaAsMillis, dirCreateAll, dirList, parseOrDisplayMessage, cliFinish, cliAssertValid, cliMaybeStr, cliCombine, argList } -> [cli]

import Parser
import CodeGen

import cli.Arg.Cli exposing [CliParser]

cli =
    start = now! {}

    #cliParser : CliParser { maybeInputDir : _, maybeOutputDir : _, maybeExtension : _ }
    #cliParser =
    #    { cliCombine <-
    #        maybeInputDir: cliMaybeStr { short: "i", long: "input-directory", help: "The directory containing the templates to be compiled. Defaults to the current directory." },
    #        maybeOutputDir: cliMaybeStr { short: "o", long: "output-directory", help: "The directory Pages.roc will be written to. Defaults to the current directory." },
    #        maybeExtension: cliMaybeStr { short: "e", long: "extension", help: "The extension of the template files the CLI will search for. Defaults to `rtl`." },
    #    }
    #    |> cliFinish {
    #        name: "rtl",
    #        version: "0.2.0",
    ...
    #when parseOrDisplayMessage cliParser (argList! {}) is
    #    Err msg -> line msg
    #    Ok args -> generate! args start
    #
    generate! {maybeInputDir: Err {}, maybeOutputDir: Err {}, maybeExtension: Err {}} start
...
info : Str -> Task {} _
info = \msg ->
    line! "\u(001b)[34mINFO:\u(001b)[0m $(msg)"
